    ...
    <div class="big">
                        ...
                        <div class="main-login-DK">
                            <form action="signup_inc_.php" method="POST">
                                <table class="tb_DN">
                                    ...
                                    <tr>
                                        <td><input class="input-tb" type="text" name="username" placeholder="Tên đăng nhập"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input class="input-tb" type="text" name="fullname" placeholder="H và Tên"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
        ...
        <footer>
            ...
            <div class="container-center privacy-policy">
                ...
                <a href=""><img src="../asset/img/tiktok_1.png" alt=""></a>
                </div>
            </div>
            </div>
        </footer>
