...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../asset/img/logo-tab.png" type="image/x-icon" />
    <title>Admin Plantique</title>
              ...
              <div class="header-right">
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="assets/images/lead/lead6.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Phạm Hoàng Vũ
                ...
                <div class="profile-box ml-15">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    <li class="divider"></li>
                    <li>
                      <a href="../page/logout.php"> <i class="lni lni-exit"></i> Sign Out </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
